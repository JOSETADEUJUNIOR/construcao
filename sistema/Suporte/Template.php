...
use sistema\Controlador\Admin\AdminConfiguracao;
...
class Template
{
    ...
    private function helpers(): void
    {
        array(
            ...
            $this->twig->addFunction(
                new \Twig\TwigFunction('configs', function () {
                    return AdminControlador::configs();
                })
            ),
            $this->twig->addFunction(
            ...
            $this->twig->addFunction(
                new \Twig\TwigFunction('formataData', function (string $data) {
                    return Helpers::formatarDataBrasil($data);
                })
            ),
            $this->twig->addFunction(
                new \Twig\TwigFunction('formatarValor', function (float $numero) {
                    return Helpers::formatarValor($numero);
                })
            ),
            $this->twig->addFunction(
